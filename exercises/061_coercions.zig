...
//
// 1. Types can always be made _more_ restrictive, never less!
//
//    var foo: u8 = 5;
//    var p1: *u8 = &foo;
...
//
// 8. Compile-time numbers coerce to compatible types (refers to numbers that are "abrupt" and evaluated during compilation).
//
